...
class MailThread(models.AbstractModel):
    ...
    def message_parse(self, message, save_original=False):
        ...
        # if author_id:
        #     pec_msg_dict['author_id'] = author_id.id
    ...
    #     """
    #     Search for a partner and if not found create it.
    #     """
    ...
    #             {
    #                 'name': pec_address,
    #                 'email': '_please_complete_@_or_merge.invalid',
    ...
    def _notify_get_recipients_groups(self, message, model_description, msg_vals=None):
        ...
        # pec_manager = self.env['mail.alias.domain'].search_read([('id', '=', message.record_alias_domain_id.id)])
        # _logger.info(pec_manager)
